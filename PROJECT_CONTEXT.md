...
its authoritative product and implementation specification. Subphases 9.1–9.3
are implemented: Vite/React/TypeScript scaffold, typed API client, design
tokens, primitives, workflow patterns, application shell, product entry, and
case intake. FastAPI retains all approval, execution, idempotency, and
