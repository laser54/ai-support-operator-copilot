...
Do not add a full frontend, real ticketing integrations, multi-agent supervisors, authentication, payments, or autonomous sends before this path is tested end to end.
